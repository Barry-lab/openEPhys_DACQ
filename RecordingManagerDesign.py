...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 479, 474))
        ...
        self.pb_badChan = QtGui.QPushButton(self.f_badChan)
        self.pb_badChan.setMinimumSize(QtCore.QSize(85, 29))
        self.pb_badChan.setMaximumSize(QtCore.QSize(85, 29))
        self.pb_badChan.setObjectName(_fromUtf8("pb_badChan"))
        self.horizontalLayout_22.addWidget(self.pb_badChan)
        ...
        self.frame_18 = QtGui.QFrame(self.scrollAreaWidgetContents)
        self.frame_18.setMaximumSize(QtCore.QSize(16777215, 49))
        ...
        self.horizontalLayout_20 = QtGui.QHBoxLayout(self.frame_18)
        self.horizontalLayout_20.setObjectName(_fromUtf8("horizontalLayout_20"))
        self.plainTextEdit_36 = QtGui.QPlainTextEdit(self.frame_18)
        self.plainTextEdit_36.setMaximumSize(QtCore.QSize(16777215, 29))
        self.plainTextEdit_36.setReadOnly(True)
        self.plainTextEdit_36.setObjectName(_fromUtf8("plainTextEdit_36"))
        self.horizontalLayout_20.addWidget(self.plainTextEdit_36)
        self.pushButton_18 = QtGui.QPushButton(self.frame_18)
        self.pushButton_18.setEnabled(False)
        self.pushButton_18.setMinimumSize(QtCore.QSize(85, 29))
        self.pushButton_18.setMaximumSize(QtCore.QSize(85, 29))
        ...
        self.pt_led_angle = QtGui.QPlainTextEdit(self.frame_18)
        self.pt_led_angle.setMaximumSize(QtCore.QSize(16777215, 29))
        self.pt_led_angle.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.pt_led_angle.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.pt_led_angle.setLineWrapMode(QtGui.QPlainTextEdit.NoWrap)
        self.pt_led_angle.setObjectName(_fromUtf8("pt_led_angle"))
        self.horizontalLayout_20.addWidget(self.pt_led_angle)
        ...
        self.pt_rec_folder.setMaximumSize(QtCore.QSize(16777215, 29))
        ...
        self.pb_auto_rec_folder = QtGui.QPushButton(self.frame)
        self.pb_auto_rec_folder.setMaximumSize(QtCore.QSize(16777215, 29))
        self.pb_auto_rec_folder.setObjectName(_fromUtf8("pb_auto_rec_folder"))
        self.horizontalLayout_2.addWidget(self.pb_auto_rec_folder)
        self.pb_manual_rec_folder = QtGui.QPushButton(self.frame)
        self.pb_manual_rec_folder.setMaximumSize(QtCore.QSize(16777215, 29))
        self.pb_manual_rec_folder.setObjectName(_fromUtf8("pb_manual_rec_folder"))
        self.horizontalLayout_2.addWidget(self.pb_manual_rec_folder)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pb_badChan.setText(_translate("MainWindow", "Load Last", None))
        self.plainTextEdit_36.setPlainText(_translate("MainWindow", "LED angle", None))
        ...
        self.pb_auto_rec_folder.setText(_translate("MainWindow", "Auto", None))
        self.pb_manual_rec_folder.setText(_translate("MainWindow", "Manual", None))
