...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 537, 584))
        ...
        self.pb_init_devices = QtGui.QPushButton(self.f_buttons)
        self.pb_init_devices.setEnabled(True)
        self.pb_init_devices.setObjectName(_fromUtf8("pb_init_devices"))
        self.verticalLayout_2.addWidget(self.pb_init_devices)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pb_init_devices.setText(_translate("MainWindow", "Initialize Devices", None))
