...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pb_waveformGUI = QtGui.QPushButton(self.frame_2)
        self.pb_waveformGUI.setMinimumSize(QtCore.QSize(0, 29))
        self.pb_waveformGUI.setMaximumSize(QtCore.QSize(16777215, 29))
        self.pb_waveformGUI.setObjectName(_fromUtf8("pb_waveformGUI"))
        self.verticalLayout_2.addWidget(self.pb_waveformGUI)
        self.sb_speed_cut = QtGui.QSpinBox(self.frame_2)
        self.sb_speed_cut.setMinimumSize(QtCore.QSize(0, 29))
        self.sb_speed_cut.setMaximumSize(QtCore.QSize(16777215, 29))
        self.sb_speed_cut.setObjectName(_fromUtf8("sb_speed_cut"))
        self.verticalLayout_2.addWidget(self.sb_speed_cut)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sb_speed_cut.setSuffix(_translate("MainWindow", " cm/s", None))
        self.sb_speed_cut.setPrefix(_translate("MainWindow", "Speed cut ", None))
